...
import { MapPin, Calendar, Tag, FileText, ArrowLeft, AlertCircle } from "lucide-react";
  ...
  return (
    <div className="min-h-screen py-12 px-6">
      <div className="container mx-auto max-w-4xl">
        ...
        >
          <h1 className="text-4xl font-bold mb-2">Report Lost Item</h1>
          <p className="text-muted-foreground mb-12">
            Help us find your item with detailed information
          </p>
            ...
            {currentStep === 0 && (
              ...
              >
                ...
                {formData.description.length > 10 && (
                  <AITooltip
                    text="Great! Adding details like color, brand, and unique features will help our AI find better matches."
                    delay={500}
                  />
                )}
                ...
                {formData.location && (
                  <div className="h-64 rounded-[12px] bg-muted/30 border border-white/20 
                    ...
                    <div className="text-center text-muted-foreground">
                      ...
                      <p>Map preview: {formData.location}</p>
                    </div>
                  </div>
                )}
              </motion.div>
